 ...
 */
class MasterClassCohort extends \Application\Entity\MasterClassCohort implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Application\\Entity\\MasterClassCohort' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\MasterClassCohort' . "\0" . 'cohortName', '' . "\0" . 'Application\\Entity\\MasterClassCohort' . "\0" . 'startDate', '' . "\0" . 'Application\\Entity\\MasterClassCohort' . "\0" . 'uuid', '' . "\0" . 'Application\\Entity\\MasterClassCohort' . "\0" . 'createdOn', '' . "\0" . 'Application\\Entity\\MasterClassCohort' . "\0" . 'isActive'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MasterClassCohort $proxy) {
