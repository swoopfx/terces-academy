 ...
 */
class InternshipCohort extends \Application\Entity\InternshipCohort implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (InternshipCohort $proxy) {
