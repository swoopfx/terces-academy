 ...
 */
class P6FreeCohort extends \Application\Entity\P6FreeCohort implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Application\\Entity\\P6FreeCohort' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\P6FreeCohort' . "\0" . 'cohortName', '' . "\0" . 'Application\\Entity\\P6FreeCohort' . "\0" . 'startDate', '' . "\0" . 'Application\\Entity\\P6FreeCohort' . "\0" . 'uuid', '' . "\0" . 'Application\\Entity\\P6FreeCohort' . "\0" . 'createdOn', '' . "\0" . 'Application\\Entity\\P6FreeCohort' . "\0" . 'isActive'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (P6FreeCohort $proxy) {
