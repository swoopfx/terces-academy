 ...
 */
class CourseContent extends \Application\Entity\CourseContent implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Application\\Entity\\CourseContent' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\CourseContent' . "\0" . 'arrange', '' . "\0" . 'Application\\Entity\\CourseContent' . "\0" . 'uuid', '' . "\0" . 'Application\\Entity\\CourseContent' . "\0" . 'title', '' . "\0" . 'Application\\Entity\\CourseContent' . "\0" . 'banner', '' . "\0" . 'Application\\Entity\\CourseContent' . "\0" . 'snippetVideo', '' . "\0" . 'Application\\Entity\\CourseContent' . "\0" . 'video', '' . "\0" . 'Application\\Entity\\CourseContent' . "\0" . 'isActive', '' . "\0" . 'Application\\Entity\\CourseContent' . "\0" . 'createdOn', '' . "\0" . 'Application\\Entity\\CourseContent' . "\0" . 'updatedOn', '' . "\0" . 'Application\\Entity\\CourseContent' . "\0" . 'courses', '' . "\0" . 'Application\\Entity\\CourseContent' . "\0" . 'description', '' . "\0" . 'Application\\Entity\\CourseContent' . "\0" . 'resources'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CourseContent $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setCourses(\Application\Entity\Courses $courses)
    {
    ...
    public function getSnippetVideo()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSnippetVideo', []);

        return parent::getSnippetVideo();
    }
    ...
    public function setSnippetVideo(string $snippetVideo)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSnippetVideo', [$snippetVideo]);

        return parent::setSnippetVideo($snippetVideo);
    }
     ...
     * {@inheritDoc}
     */
    public function addResources(\Application\Entity\Resources $res)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addResources', [$res]);

        return parent::addResources($res);
    }
